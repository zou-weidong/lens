...
const askBooleanQuestionChannelListenerInjectable = getMessageChannelListenerInjectable(askBooleanQuestionChannelInjectable, (di) => {
  ...
  return ({ id: questionId, title, question }) => {
