...
import { AddSecretDialog } from "./dialogs/add/view";
...
import openAddSecretDialogInjectable from "./dialogs/add/open.injectable";
...
const NonInjectedSecrets = observer(({
  openAddSecretDialog,
  secretStore,
}: Dependencies & SecretsProps) => (
  <>
