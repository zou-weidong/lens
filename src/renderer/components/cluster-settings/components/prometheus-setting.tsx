...
import {  } from "../../../../common/vars";
import type { MetricProviderInfo } from "../../../../common/k8s-api/endpoints";
import { metricsApi } from "../../../../common/k8s-api/endpoints";
          ...
          <>
            ...
            <section>
              ...
              <small className="hint">
                ...
                ({"<namespace>/<service>:<port>"}). {this.props.productName} tries to auto-detect address if left empty.
              </small>
            </section>
          </>
        )}
