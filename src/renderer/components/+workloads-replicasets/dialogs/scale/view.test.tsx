...
import { ReplicaSetScaleDialog } from "./view";
...
describe("<ReplicaSetScaleDialog />", () => {
  ...
  beforeEach(async () => {
    ...
    const mockApi = createMockInstance(ReplicaSetApi);

    mockApi.getReplicas.mockImplementation(async () => initReplicas);

    di.override(replicaSetApiInjectable, () => mockApi);
  });
