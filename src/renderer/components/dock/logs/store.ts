...
import type { PodLogsQuery, Pod, QueryForLogs } from "../../../../common/k8s-api/endpoints";
...
export class LogStore {
   ...
   */
  private async loadLogs(computedPod: IComputedValue<Pod | undefined>, logTabData: IComputedValue<LogTabData>, params: Partial<PodLogsQuery>): Promise<string[]> {
