...
import type { Cluster, ClusterApi, IClusterMetrics, IMetricsReqParams } from "../../../../common/k8s-api/endpoints";
import { getMetricsByNodeNames, normalizeMetrics } from "../../../../common/k8s-api/endpoints";
...
export class ClusterOverviewStore extends KubeObjectStore<Cluster> implements ClusterOverviewStorageState {
  ...
  private init() {
    const { nodeStore } = this.dependencies;
    ...
    reaction(() => nodeStore.items.length, () => {
