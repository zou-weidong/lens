...
import type { KubernetesClusterCategory } from "../../../category/declarations/kubernetes-cluster";
import kubernetesClusterCategoryInjectable from "../../../category/declarations/kubernetes-cluster.injectable";
