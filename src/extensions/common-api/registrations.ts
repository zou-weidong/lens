...
export type { KubeObjectMenuRegistration, KubeObjectMenuComponents } from "../../renderer/components/kube-object-menu/registration";
export type { AppPreferenceRegistration, AppPreferenceComponents } from "../../renderer/components/+preferences/app-preferences.injectable";
...
export type { ShellEnvModifier, ShellEnvContext } from "../../main/shell-session/shell-env-modifier/types";
